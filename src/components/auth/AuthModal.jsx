  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="sm">
      <div className="p-6 md:p-8 text-center">
        {/* Google G Logo Badge */}
        <div className="w-16 h-16 rounded-2xl bg-surface border border-border flex items-center justify-center mx-auto mb-5 shadow-lg">
        ...
        <h3 className="text-xl font-bold text-text mb-2">Sign In with Google</h3>
        <p className="text-xs text-muted leading-relaxed mb-6">
          Sign in with your Google account to access member features and portfolio capabilities.
        </p>
